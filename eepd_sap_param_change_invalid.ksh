#!/bin/ksh 
#####################################################################################################################################
#   Name:  EEPD_sap_param_change.ksh                                                                                                #
#   Date:  03/27/2017                                                                                                               #
# Author:  Satish Nakka                                                                                                             #
...
#==================================================================================================================================
#Verifying the existence of fifth argument for CDC date output file name
#==================================================================================================================================
if [ -z "$5" ]
then
...
echo 'LASTRUNDT param name from 3rd argument  : '$last_dt >> $lg_fl
...
#==================================================================================================================================
last_run_dt_curr=`cat $tgt_dir/$output_file | sort -1nr | head -1`

echo 'Curr Last Run Dt 			                  : '$last_run_dt_curr >> $lg_fl
